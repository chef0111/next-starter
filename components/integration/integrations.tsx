...
export function Integrations() {
  return (
    <div className="relative mx-auto grid max-w-4xl grid-cols-1 gap-12 md:grid-cols-2 md:items-center">
    ...
    >
      {logo && (
        <Image
          alt={logo.alt}
          className={cn(
            'pointer-events-none size-8 object-contain p-1 select-none dark:invert'
          )}
          height={40}
          src={logo.src}
          width={40}
